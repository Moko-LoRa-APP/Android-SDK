...
public class WriteAlarmUploadIntervalTask extends OrderTask {
    ...
    public WriteAlarmUploadIntervalTask(MokoOrderTaskCallback callback) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_ALARM_UPLOAD_INTERVAL, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
    }
