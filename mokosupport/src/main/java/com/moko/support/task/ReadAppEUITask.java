...
public class ReadAppEUITask extends OrderTask {
    ...
    public ReadAppEUITask(MokoOrderTaskCallback callback) {
        super(OrderType.CHARACTERISTIC, OrderEnum.READ_APP_EUI, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
