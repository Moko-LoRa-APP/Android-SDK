...
public class WriteMulticastAppSKeyTask extends OrderTask {
    private static final int ORDERDATA_LENGTH = 19;

    public byte[] orderData;

    public WriteMulticastAppSKeyTask(MokoOrderTaskCallback callback) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_MULTICAST_APPSKEY, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
    }
