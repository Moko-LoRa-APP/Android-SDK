...
public class WriteNwkSKeyTask extends OrderTask {
    private static final int ORDERDATA_LENGTH = 19;

    public byte[] orderData;

    public WriteNwkSKeyTask(MokoOrderTaskCallback callback) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_NWK_SKEY, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
    }
