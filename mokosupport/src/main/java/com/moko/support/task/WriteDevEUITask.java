...
public class WriteDevEUITask extends OrderTask {
    ...
    public WriteDevEUITask(MokoOrderTaskCallback callback) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_DEV_EUI, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
    }
