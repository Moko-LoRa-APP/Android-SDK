...
public class WriteMulticastNwkSKeyTask extends OrderTask {
    ...
    public WriteMulticastNwkSKeyTask(MokoOrderTaskCallback callback) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_MULTICAST_NWKSKEY, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
    }
