...
public class ReadMulticastAddrTask extends OrderTask {
    ...
    public ReadMulticastAddrTask(MokoOrderTaskCallback callback) {
        super(OrderType.CHARACTERISTIC, OrderEnum.READ_MULTICAST_ADDRESS, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
