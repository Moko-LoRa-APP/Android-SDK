...
public class WriteHumiDataTask extends OrderTask {
    ...
    public WriteHumiDataTask(MokoOrderTaskCallback callback) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_HUMI, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
    }
