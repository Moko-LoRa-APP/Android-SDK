...
public class WriteTempDataTask extends OrderTask {
    ...
    public WriteTempDataTask(MokoOrderTaskCallback callback) {
        super(OrderType.CHARACTERISTIC, OrderEnum.WRITE_TEMP, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
    }
