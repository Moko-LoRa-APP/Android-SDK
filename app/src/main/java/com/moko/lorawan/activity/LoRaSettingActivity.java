...
public class LoRaSettingActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    @BindView(R.id.rb_modem_abp)
    RadioButton rbModemAbp;
    @BindView(R.id.rb_modem_otaa)
    RadioButton rbModemOtaa;
    @BindView(R.id.rg_modem)
    RadioGroup rgModem;
    ...
    @BindView(R.id.rb_type_classa)
    RadioButton rbTypeClassa;
    @BindView(R.id.rb_type_classc)
    ...
    TextView tvRegion;
    @BindView(R.id.ll_report_invterval)
    LinearLayout llReportInvterval;
    @BindView(R.id.rb_type_unconfirmed)
    RadioButton rbTypeUnconfirmed;
    @BindView(R.id.rb_type_confirmed)
    ...
    @BindView(R.id.tv_report_interval_tips)
